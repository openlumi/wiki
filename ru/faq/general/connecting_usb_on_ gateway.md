...
![Фото 1](https://github.com/DivanX10/Openwrt-scripts-for-gateway-zhwg11lm/blob/main/image/usb%20connection%20and%20configuration%201-2.jpg)
...
## Подключение USB.
Подключаем внешний USB как показано на **Фото 2** Для включения режима OTG необходимо замкнуть USB-GND и USB-ID. Для питания вашего устройства необходимо на контакт USB+5v подать +5v. Их удобно взять с колодки питания контакт+5v **Фото 2**. 
